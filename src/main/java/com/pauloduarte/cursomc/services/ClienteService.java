...
public class ClienteService {
	...
	public Cliente findByEmail(String email) {
		...
		if(obj==null) {
			throw new ObjectNotFoundException(
					"Objecto não encontrado. Id: " + user.getId() + ", Tipo: " + Cliente.class.getName());
		}
		return obj;
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getNif(), TipoCliente.toEnum(objDto.getTipo()),pe.encode(objDto.getSenha()));
